...
var AppController = function () {
    ...
    var _getAutocomplete_decorators;
    var AppController = _classThis = /** @class */ (function () {
        ...
        AppController_1.prototype.getAutocomplete = function (queryParams) {
            var query = queryParams.query, _a = queryParams.limit, limit = _a === void 0 ? 10 : _a, _b = queryParams.page, page = _b === void 0 ? 1 : _b;
    ...
    (function () {
        ...
        _getAutocomplete_decorators = [(0, common_1.Get)('autocomplete')];
        ...
        __esDecorate(_classThis, null, _getAutocomplete_decorators, { kind: "method", name: "getAutocomplete", static: false, private: false, access: { has: function (obj) { return "getAutocomplete" in obj; }, get: function (obj) { return obj.getAutocomplete; } }, metadata: _metadata }, null, _instanceExtraInitializers);
